<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestorPinactivo.aspx.cs" Inherits="Trustin.Admin.GestorPinactivo" %>
...
<body>
    ...
    <div class="sidebar">
        <div class="side-header">
            <%--<a href="intranetUsaurio.aspx" class="text-black"><span class="text-primary">
			 <img  style="width: 80px; height: 50px" src="../ContentNathalia/images/LOGO-COLOR.png" /></a>	--%>
...
Admin_Agregar_Rol.aspx">
                    ...
                    <li>
                        <a href="/Trustin_3F/Admin/
gestorPerfiles.aspx" class="active">
...
ModuloEmparejamiento.aspx">
            ...
            <div class="header-content">
                ...
                <div class="header-menu">
                    ...
                    <div class="notify-icon">
                        ...
                        <span class="notify"><a style="color: white" href="/Trustin_3F/Admin/.aspx">4</a></span>
                    </div>
    ...
    <div class="container" style="justify-content: center; align-items: center">
        <h3 style="color: #8C2641; font-size: 22px; margin-bottom: 20px; margin-top: 95px; margin: 65px; text-align: center"><b><i class="fa-solid fa-user-minus"></i>Perfiles Inactivos </b></h3>
        <form runat="server">
            <label style="color: black"><b>Filtrado por</b></label>


            <asp:DropDownList Style="border-radius: 8px" ID="ddlBusquedaEmail" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSelect_SelectedIndexChanged">
            ...
            <div>
                <asp:TextBox ID="txtbuscar" Style="background-color: #5cb85c; border: none; color: black; background-color: lightpink; border-radius: 8px; height: 38px" runat="server" placeholder="Ingresar ID o email   "></asp:TextBox>
                <asp:Button ID="btnBuscar" class="btn btn-danger" runat="server" Text="Buscar" type="button" Style="color: white; margin-right: -5px" OnClick="btnBuscar_Click" />
            </div>
            ...
            <asp:GridView ID="gvPerfil" CssClass="table-active" runat="server" Style="border: 1px solid; border-color: #8C2641; width: 100%; justify-content: center; align-items: center; text-align: center;" OnRowCommand="gvPerfil_RowCommand">
                <Columns>
                    <asp:TemplateField HeaderText="Activar">
                        <ItemTemplate>
                            <asp:Button ID="btnActivar" runat="server" class="btn btn-success" Text="Activar" CommandName="Activar" CommandArgument="<%# Container.DataItemIndex %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
