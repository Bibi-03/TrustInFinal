...
{
    public partial class ModuloEmparejamiento : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            string cn = "Server=tiusr25pl.cuc-carrera-ti.ac.cr\\MSSQLSERVER2019;Database=tiusr25pl_TrustIn;User Id=warayar;Password=warayar@!!!;";
            SqlConnection sqlConectar = new SqlConnection(cn);
            SqlCommand cmd = new SqlCommand("SP_infoModuloEmp", sqlConectar)
            { CommandType = CommandType.StoredProcedure };
            cmd.Connection.Open();
            cmd.Parameters.Add("@interesComun", SqlDbType.Int).Value = ddlInteresesComun.SelectedValue;
            cmd.Parameters.Add("@perfilCompleto", SqlDbType.VarChar, 15).Value = ddlPorcentaje.Text;
            cmd.Parameters.Add("@perfilVerificado", SqlDbType.VarChar, 15).Value = ddlperfilverificado.Text;
