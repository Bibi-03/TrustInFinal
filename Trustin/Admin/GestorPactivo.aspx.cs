...
{
    public partial class GestorPactivo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string query = "select p.id_perfil as Id_Usuario,p.perfil_email as Email,e.estado_nombre as Estado from Perfil p, Estado e where p.id_estado = e.id_estado and p.id_estado = 1";
        ...
        {
            string opcionSeleccionada = ddlBusqueda.SelectedValue;
        ...
        public DataTable cargaUsuarioID(string terminoBusqueda)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("SP_BusquedaActivoIDp", sqlConectar))
                {
        ...
        public DataTable cargaEmail(string terminoBusqueda)
        {
            ...
            using (SqlConnection sqlConectar = new SqlConnection(cn))
            {
                using (SqlCommand cmd = new SqlCommand("SP_BusquedaActivoEmail", sqlConectar))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
            ...
            if (e.CommandName == "Desactivar")
            {
                ...
                using (SqlConnection sqlConectar = new SqlConnection(cn))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        cmd.CommandText = "UPDATE Perfil SET id_estado = 0 WHERE id_perfil = @idperfil";
