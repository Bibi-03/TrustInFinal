               ...
               <div class="profile">
                ...
                <div class="side-menu">
                    <ul>
                        ...
                        <li>
                            <a href="/Trustin_3Final/Admin/Admin_Config.aspx" class="active">
                                <span class="las la-user-cog"></span>
                                <small>Configuración Global</small>
                            </a>
                        </li>
                        <li>
                            <a href="/Trustin_3Final/Admin/Admin_Agregar_Usuario.aspx">
                ...
                <div class="header-content">
                    ...
                    <div class="header-menu">
                        ...
                        <div class="notify-icon">
                            ...
                            <span class="notify"><a style="color: white" href="/Trustin_3Final/Admin/
